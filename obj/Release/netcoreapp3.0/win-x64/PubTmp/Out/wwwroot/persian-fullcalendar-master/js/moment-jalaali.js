        ...
        jMoment.loadPersian = function () {
            moment.defineLocale('fa'
                , {
                    ...
                    , jMonths: ('فروردین_اردیبهشت_خرداد_تیر_مرداد_شهریور_میزان_آبان_آذر_دی_بهمن_اسفند').split('_')
                    , jMonthsShort: 'فرو_ارد_خرد_تیر_امر_شهر_میزان_آبا_آذر_دی_بهم_اسف'.split('_')
                }
            )
        };
